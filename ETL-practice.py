{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "file_dir = 'C:\\\\Users\\Tamara\\Class\\Movies-ETL\\\\'\n"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "wiki_movies_dfdf = pd.DataFrame(wiki_movies)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "wiki_movies_df['Arabic'].value_counts() #basically we're looking at columns with alternative values"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [
    ...
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
       "<Figure size 432x288 with 1 Axes>"
      ]
     },
